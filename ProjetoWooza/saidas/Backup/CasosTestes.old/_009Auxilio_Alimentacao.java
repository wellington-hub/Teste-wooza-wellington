...
public class _009Auxilio_Alimentacao extends SIGPMUtils {

	// Caso de Teste
	@Test
	public void testar009() throws Exception {

		ConfigureExecution.configurarExecucaoCasosTeste("009");
	}

	// Método de Teste
	public void test009Auxilio_Alimentacao() throws Exception {
		...
		clicarBotaoEntrar();
		//Alimentacao 
		clicarAuxilioAlimentacao();
		parcelaAlimentacao();
		enviarAlimentacao();
		//Refeicao
		clicarAuxilioRefeicao();
		parcelaRefeicao();
		enviarRefeicao();
